...
extension UIView {
    ...
    func anchor(top: NSLayoutYAxisAnchor?, bottom: NSLayoutYAxisAnchor?, leading: NSLayoutXAxisAnchor?, trailing: NSLayoutXAxisAnchor?, padding: UIEdgeInsets = .zero, size: CGSize = .zero) -> AnchoredConstraints {
        ...
        if let leading = leading {
            anchoredConstraints.leading = leadingAnchor.constraint(equalTo: leading, constant: padding.bottom)
        }
    ...
    func fillSuperview(padding: UIEdgeInsets = .zero) {
        ...
        if let supervieewTrailingAnchor = superview?.trailingAnchor {
            trailingAnchor.constraint(equalTo: supervieewTrailingAnchor, constant: padding.right).isActive = true
        }
    }
...
//Add an extension file for text
